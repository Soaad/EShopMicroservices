...
public static class OrderExtension
{
    public static IEnumerable<OrderDto> ToOrderDtoList(this IEnumerable<Order> orders)
    {
        return orders.Select(order => new OrderDto(
            ...
            ShippingAddress: new AddressDto(order.ShippigAddress.FirstName, order.ShippigAddress.LastName, order.ShippigAddress.EmailAddress!, order.ShippigAddress.AddressLine, order.ShippigAddress.Country, order.ShippigAddress.State, order.ShippigAddress.ZipCode),
